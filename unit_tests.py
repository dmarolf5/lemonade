...
def days_cost(day):
	"""
	Invocation: get_signs(day, assets, sign_cost)
	Preconditions: day, assets, sign_cost are numbers.
	Postconditions: Return the integer value of (4 + 0.3 * day)
...
def get_glasses(day):
	"""
	Invocation: get_glasses(day)
	Preconditions: day is a number.
	Postconditions: return 12 if day < 9, 0 otherwise.
...
def base_demand(price):
	"""
	Invocation: base_demand(price)
	Preconditions: price is a number.
	Postconditions: Return the maximum of (108 - 0.8 * price * price) and 0.
...
def advertising_multiplier(signs):
	"""
	Invocation: advertising_multiplier(signs)
	Preconditions: signs is a number.
	Postconditions: Return 1 - exp(-signs / 2) / 2.
	
	>>> advertising_multiplier(1)
	0.6967346701436833
	>>> advertising_multiplier(2)
	0.8160602794142788
	>>> advertising_multiplier(3)
	0.888434919925785
	"""
